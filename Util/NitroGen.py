...
class SapphireGen:
    ...
    def get_webhook_url(self):
        self.clear_screen()
        return input("Veuillez entrer l'URL du Webhook Discord: ")
    ...
    def welcome_message(self):
        self.clear_screen()
        self.display_message("Générateur de liens de cadeaux Discord.", Fore.MAGENTA, Style.BRIGHT)

    def goodbye_message(self):
        self.display_message("Merci d'avoir utilisé mon NitroGen", Fore.CYAN, Style.BRIGHT)
